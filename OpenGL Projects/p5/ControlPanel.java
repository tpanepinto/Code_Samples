...

{
    ...
    private void buildGUI() {
        ...
        sceneLabel = new JTextArea( "Scene label" );
        JScrollPane pane = new JScrollPane( sceneLabel );
        sceneLabel.setEditable( false );
        sceneLabel.setLineWrap( true );
        this.add( pane );
    ...
    private void buildButtons() {
        ...
        //----------------show axis check box--------------------------------
        JCheckBox triChecker = new JCheckBox( "Wire Frame" );
        triChecker.setSelected( false );
        triChecker.addActionListener(

                new ActionListener() {
                    public void actionPerformed( ActionEvent ae ) {
                        SceneManager.setTriangulation
                                ( ( ( JCheckBox ) ae.getSource() ).isSelected() );
                    }
                }
        );
        bPanel.add( triChecker );
