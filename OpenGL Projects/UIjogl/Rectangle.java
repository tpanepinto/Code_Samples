...
public class Rectangle extends Shape{
    ...
    public Rectangle (Point location){
        ...
        points[0] = p;
        Point sp = new Point(0, 200);
        points[1] = sp;
        Point qp  = new Point(200, 200);
        points[2] = qp;
        Point rp = new Point(200, 0);
        points[3] = rp;
    ...
    public Rectangle (Point location, float height, float width, Color fill, Color boundry)
    {
        ...
        setColor( fill.getRed(), fill.getGreen(), fill.getBlue() );
    ...
    **/
    public void fillShape(){
        ...
        for (int i =0; i< 4 ; i++)
        {
           ...
           // System.out.println("This is point " + i + " @ " + points[i].getX() + " " + points[i].getY());
        }
        gl.glEnd();
    }
    //-----------------boundShape-----------------------------
