...
//-------------Textured Box Pieces--------------------------------
    ...
    private void makeTopTextured() {
        ...
        JOGL.gl.glTexCoord2f( 1f, 2f );
        JOGL.gl.glVertex3f( ( 0 + ( length / 2f ) ), ( 0 + ( length / 2f ) ), ( 0 - ( length / 2f ) ) );


        JOGL.gl.glTexCoord2f( 0f, 2f );
        JOGL.gl.glVertex3f( ( 0 - ( length / 2f ) ), ( 0 + ( length / 2f ) ), ( 0 - ( length / 2f ) ) );
    ...
    private void makeRightTextured() {
        ...
        JOGL.gl.glTexCoord2f( 2f, 0f );
        JOGL.gl.glVertex3f( ( 0 + ( length / 2f ) ), ( 0 - ( length / 2f ) ), ( 0 - ( length / 2f ) ) );


        JOGL.gl.glTexCoord2f( 2f, 1f );
        JOGL.gl.glVertex3f( ( 0 + ( length / 2f ) ), ( 0 + ( length / 2f ) ), ( 0 - ( length / 2f ) ) );
